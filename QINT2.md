# Квантовые производные и интерполяционные полиномы

> Вся эта тема начинается с поиска квантовых аналогов для операций дифференцирования. Изначально Производные вводил И.Ньютон.

_Анатолий М. Георгиевский_, [05.11.2024 15:30]
