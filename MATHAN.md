...
Множество ортонормированных функций позволяют построить ряд Фурье. В общем случае ряд Фурье может быть построен от любого полного набора ортонормированных функций со скалярным произведением. Вместе образуют линейное пространство суммируемых функций на интервале $L^2([a,b])$ - гильбертово пространство. Скалярное произведение непрерывных функций определяется 
