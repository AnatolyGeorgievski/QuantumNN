...
где $U$ является ортогональной, а H является верхней матрицей Xессенберга, то есть имеет нули ниже первой поддиагонали. Приведение к Гессенбергу является первым шагом в разложении Шура для несимметричной задачи о собственных значениях, но применяется и в других областях.
...
где:\
$U$ - унитарная матрица;\
$U^\ast$- эрмитово-сопряженная матрица;\
