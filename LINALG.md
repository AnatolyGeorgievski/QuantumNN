...
В приложении Аффинных (обратимых) преобразований необходимо находить обратную матрицу и находить разложения для перехода в базис ортогональных собственных векторов. В этой связи вводятся понятия ортогональных матриц, собственных векторов и собственных значений. 
...
1. Выбрать вектор столбец $$u_1 = x_1, x_1 \neq 0$$
