...
Для квадратной матрицы число обусловленности $k_2(A) = \Vert A\Vert_2 \cdot \Vert A^{-1}\Vert_2$ выражается через норму матрицы. Если число обусловленности мало, то говорят, матрица хорошо-обусловленна (well-conditioned). Если велико, то плохо обусловлена (ill-conditioned). Для ортогональной матрицы $Q$, $κ_2(Q) = \Vert Q \Vert _2 \cdot \Vert Q^T \Vert _2 = 1$ (perfect conditioned).
